    ...
    () => [
      ...
      },
      {
        ...
        muiEditTextFieldProps: {
          required: true,
          error: !!validationErrors?.namaPetugas,
          helperText: validationErrors?.namaPetugas,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
              namaPetugas: undefined,
            }), 
        },
      },
      {
...
function useDeleteUser() {
  ...
  return useMutation({
    mutationFn: async (userId) => {
      const response = await fetch(
        `${apiUrl}/petugasPerekaman/${userId}`,
        {
          method: "DELETE",
        }
      );
...
function validateUser(user) {
  return {
    namaPetugas: !validateRequired(user.namaPetugas)
