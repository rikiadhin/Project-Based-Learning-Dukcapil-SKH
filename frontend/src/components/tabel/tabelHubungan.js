...
const Example = () => {
     ...
     const columns = useMemo(
          () => [
               ...
               {
                    accessorKey: "statusHubungan",
                    header: "Status Hubungan",
                    muiEditTextFieldProps: {
                         required: true,
                         error: !!validationErrors?.statusHubungan,
                         helperText: validationErrors?.statusHubungan,
                         //remove any previous validation errors when user focuses on the input
                         onFocus: () =>
                              setValidationErrors({
                                   ...validationErrors,
                                   statusHubungan: undefined,
                              }),
                    },
               },
               // {
...
export default TableHubungan;

const validateRequired = (value) => !!value.length;

function validateUser(user) {
     return {
          statusHubungan: !validateRequired(user.statusHubungan)
               ? "Nama Hubungan is Required"
               : "",
