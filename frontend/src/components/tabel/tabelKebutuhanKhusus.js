...
const Example = () => {
     ...
     const columns = useMemo(
          () => [
               ...
               {
                    accessorKey: "namaKebutuhanKhusus",
                    header: "Nama Kebutuhan Khusus",
                    muiEditTextFieldProps: {
                         required: true,
                         error: !!validationErrors?.namaKebutuhanKhusus,
                         helperText: validationErrors?.namaKebutuhanKhusus,
                         //remove any previous validation errors when user focuses on the input
                         onFocus: () =>
                              setValidationErrors({
                                   ...validationErrors,
                                   namaKebutuhanKhusus: undefined,
                              }),
                    },
               },
          ],
...
export default TableKebutuhanKhusus;

const validateRequired = (value) => !!value.length;

function validateUser(user) {
     return {
          namaKebutuhanKhusus: !validateRequired(user.namaKebutuhanKhusus)
               ? "Nama Kebutuhan Khusus is Required"
               : "",
          // nomorWA: !validateRequired(user.nomorWA) ? "Nomor WhatsApp is Required" : ""
     };
}
